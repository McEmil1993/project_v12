          ...
          <tbody>
            ...
            @foreach($service as $services)   
                <tr>
                    ...
                    <td>
                        <a href="/admin/services/{{$services->id}}" class="btn btn-warning btn-sm float-left mr-1"
                                style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="view"
                                data-placement="bottom"><i class="fas fa-eye"></i></a>
                        <a href="/admin/services/{{$services->id}}/edit" class="btn btn-primary btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="edit" data-placement="bottom"><i class="fas fa-edit"></i></a>
                        <!-- <form method="POST" action="{{route('brand.destroy',[$services->id])}}">
                          @csrf 
                          @method('delete')
                              <button class="btn btn-danger btn-sm dltBtn" data-id={{$services->id}} style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" data-placement="bottom" title="Delete"><i class="fas fa-trash-alt"></i></button>
                        </form> -->
                    </td>
