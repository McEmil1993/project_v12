                ...
                <form class="border px-4 pt-2 pb-3" method="POST" action="{{route('profile-update',$profile->id)}}">
                    ...
                    <div class="form-group">
                        ...
                        <input id="inputAddress" type="text" name="address" placeholder="Enter address"
                            value="{{$profile->user_pro->address}}" class="form-control">
                        @error('address')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input id="inputContact" type="text" name="contact" placeholder="Enter contact number"
                            value="{{$profile->user_pro->contact}}" class="form-control">
                        @error('contact')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="role" class="form-control">
                            ...
                            <option value="store" {{(($profile->role=='store')? 'selected' : '')}}>Store</option>
