...
@section('title','Moto Shop || HOME PAGE')
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.2/sweetalert.min.js"></script>
    ...
    <script>
        ...
        // Wait for the window to load to ensure all images and content are fully loaded
window.onload = function() {
  var items = document.querySelectorAll('.carousel-item');
  var maxHeight = 0;

  // Loop through the items to find the tallest one
  ...
  // Set the height of the carousel-inner to the height of the tallest item
