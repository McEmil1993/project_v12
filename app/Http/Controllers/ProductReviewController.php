...
class ProductReviewController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $user = User::where('role', 'store')
        ->join('store_info', 'store_info.user_id', '=', 'users.id')
        ->where('store_info.id', $product_info->store_id)
        ->select('users.*','store_info.id as store_id') // replace some_column with actual column name
        ->get();
        $details=[
