...
INSERT INTO `customer_info` VALUES (1,3,'CF sample','Cm Sample','Cl sample','male','09999999999','Trinidad','2024-04-20 14:29:17',NULL);
...
INSERT INTO `products` VALUES (1,1,'Sasas','sasas','<p>asasas</p>','<p>asas</p>','http://127.0.0.1:90/storage/photos/2/Sample/9.jpg',500,'S,M,L','new','active',50.00,0.00,1,1,2,2,'2024-04-16 16:26:33','2024-04-16 16:26:33'),(2,2,'Asas','asas','<p>asas</p>','<p>asas</p>','http://127.0.0.1:90/storage/photos/4/Sample/12.jpg',32,'S','new','active',78.00,0.00,1,3,NULL,3,'2024-04-17 15:54:29','2024-04-20 03:56:47');
...
CREATE TABLE `services` (
  ...
  `motorcycle_name` varchar(191) NOT NULL,
  `motorcycle_type` varchar(191) NOT NULL,
  `service_types` varchar(191) NOT NULL,
  `total_amount` decimal(10,2) NOT NULL,
  `status` enum('pending','service_finished','cancelled') NOT NULL,
  `assigned_to` varchar(225) DEFAULT NULL,
  `service_contact` varchar(225) DEFAULT NULL,
  ...
  CONSTRAINT `services_customer_id_foreign` FOREIGN KEY (`customer_id`) REFERENCES `customer_info` (`id`),
  CONSTRAINT `services_store_id_foreign` FOREIGN KEY (`store_id`) REFERENCES `store_info` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `services` VALUES (1,'2024-04-20',1,'Mio','Scooter','Not FGunction  Head light',100.00,'service_finished','Sample',NULL,NULL,2,'2024-04-20 14:30:28','2024-04-20 08:11:05'),(2,'2024-04-20',1,'HIN','Asd','Asas',1000.00,'service_finished','Sample 2','asda','asdasd',2,'2024-04-20 15:48:03','2024-04-20 08:14:55');
...
-- Dump completed on 2024-04-20  9:18:14
